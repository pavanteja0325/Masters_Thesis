...
%\usepackage[colorlinks=true, linkcolor=blue, breaklinks, draft=false, pdfusetitle]{hyperref}
...
have not used any other media or materials than the ones referred to in this thesis.
